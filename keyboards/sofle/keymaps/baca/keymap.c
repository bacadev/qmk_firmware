 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Cmd  | Ctrl | LOWER| Space| /  CAPS /       \ Tab  \  | Bspc | RAISE|MsMid | Alt  |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |  
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_BASE] = LAYOUT(
  ...
  KC_TAB,  KC_Q,  KC_W,   KC_E,   KC_R,  KC_T,                         KC_Y,   KC_U,     KC_I,       KC_O,   KC_P,     KC_KP_ASTERISK,
  KC_ESC,  KC_A,  KC_S,   KC_D,   KC_F,  KC_G,                         KC_H,   KC_J,     KC_K,       KC_L,   KC_SCLN,  KC_QUOT,
  KC_LSFT, KC_Z,  KC_X,   KC_C,   KC_V,  KC_B,   KC_MUTE,     KC_MPLY, KC_N,   KC_M,     KC_COMM,    KC_DOT, KC_SLSH,  KC_ENTER,
             KC_LGUI, KC_LCTL, KC_LOWER, KC_SPC, KC_CAPS,     KC_TAB,  KC_BSPC,KC_RAISE, KC_MS_BTN3, KC_LALT
),
...
[_LOWER] = LAYOUT(
  ...
  KC_LSFT, KC_P6,   KC_P7,   KC_P8,   KC_P9,  KC_TRNS, _______,         _______, KC_TRNS, KC_P2,   KC_P3,   KC_P4,            KC_P5,            KC_NUBS,
...
[_RAISE] = LAYOUT(
  KC_F11 , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                         KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F12 ,
 KC_TAB,  KC_NO, KC_NO,   KC_UP,   KC_NO,    KC_NO,                              _______, KC_BRID, KC_BRIU, _______, _______, _______,
  _______, KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO,                              _______, KC_MINS, KC_EQL , _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______,            _______, _______, KC_MPRV, KC_MNXT, _______, _______, _______,
                    _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______
),
